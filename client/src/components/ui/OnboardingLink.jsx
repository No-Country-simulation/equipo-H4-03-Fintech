...
export default function OnboardingLink() {
  return (
    <main className="w-[600px] flex flex-col items-center my-4 bg-primary rounded-3xl">
      <div className="w-[500px] flex flex-col p-5 gap-4">
        <aside className="flex items-center justify-start gap-2">
          <article className="size-5 flex items-center justify-center rounded-full bg-success">
          ...
          <article className="size-5 flex items-center justify-center rounded-full bg-white">
            <span className="font-normal text-base text-success">3</span>
          </article>
